...
from server.blueprints.ajax import ajax_bp
from server.blueprints.auth import auth_bp
from server.blueprints.main import main_bp
from server.blueprints.user import user_bp
from server.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf
from server.models import Role, User, Photo, Tag, Follow, Notification, Comment, Collect, Permission
